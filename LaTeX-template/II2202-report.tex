...
Reducing the number of misplacements of items in warehouses has a huge impact on the effectiveness of a company. These human errors can cause a significant loss of money and time. Therefore, supporting warehouse staff is crucial. Current solutions mostly use hypersonic technology. In this paper we experiment with inertial measurement units to test if they are capable of fulfilling the same needs.
